...
xst -ifn xst.scr
move clkdiv4_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkdiv4_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkdiv4_exdes.ucf clkdiv4_exdes

echo 'Running map'
map -timing -pr b clkdiv4_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkdiv4_exdes -w routed.ncd routed.v
cd ..
